...
if (isset($_POST['submit']))
{
    if (!(empty($_POST['username'])))
    {
        ...
        $userQuery=$connection->CheckUique($conobj,"roomser",$_POST['username']);
...
$connection = new db();
$conobj=$connection->OpenCon();
$userQuery=$connection->InsertUser($conobj,"roomser",$name,$username,$email,$contact,$gender,$password);
if ($userQuery===TRUE) 
{
